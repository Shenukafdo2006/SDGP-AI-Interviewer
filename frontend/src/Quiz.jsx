...
const quizzes = [
...

  {
    ...
    difficulty: "Advanced",
    questions: [
      { q: "Time complexity of binary search?", a: ["O(log n)","O(n)","O(n^2)","O(1)"], correct: 0 },
      { q: "Space complexity of merge sort?", a: ["O(n)","O(log n)","O(1)","O(n log n)"], correct: 0 },
      { q: "Quick sort worst case complexity?", a: ["O(n^2)","O(n log n)","O(log n)","O(n)"], correct: 0 },
      { q: "Quick sort average case complexity?", a: ["O(n log n)","O(n^2)","O(log n)","O(n)"], correct: 0 },
      { q: "Which is stable sorting?", a: ["Merge sort","Quick sort","Heap sort","Selection sort"], correct: 0 },
      { q: "Which is not stable?", a: ["Quick sort","Merge sort","Bubble sort","Insertion sort"], correct: 0 },
      { q: "DFS uses?", a: ["Stack","Queue","Priority Queue","Heap"], correct: 0 },
      { q: "BFS uses?", a: ["Queue","Stack","Heap","Priority Queue"], correct: 0 },
      { q: "Dijkstra algorithm used for?", a: ["Shortest path","Minimum spanning tree","Sorting","Searching"], correct: 0 },
      { q: "Prim's algorithm used for?", a: ["MST","SP","Sorting","Graph traversal"], correct: 0 },
      { q: "Kruskal algorithm uses?", a: ["MST","Shortest path","DFS","BFS"], correct: 0 },
      { q: "Binary search works on?", a: ["Sorted array","Unsorted array","Linked list","Tree"], correct: 0 },
      { q: "Insertion sort worst case complexity?", a: ["O(n^2)","O(n log n)","O(n)","O(log n)"], correct: 0 },
      { q: "Heap sort complexity?", a: ["O(n log n)","O(n^2)","O(n)","O(log n)"], correct: 0 },
      { q: "Hash table average search?", a: ["O(1)","O(n)","O(log n)","O(n log n)"], correct: 0 },
      { q: "Hash table worst case?", a: ["O(n)","O(1)","O(log n)","O(n log n)"], correct: 0 },
      { q: "Dynamic programming used for?", a: ["Optimization","Searching","Sorting","Traversal"], correct: 0 },
      { q: "Greedy algorithm principle?", a: ["Local optimal leads to global optimal","Random choice","DFS","BFS"], correct: 0 },
      { q: "Divide and conquer example?", a: ["Merge sort","Bubble sort","Insertion sort","Linear search"], correct: 0 },
      { q: "Backtracking used for?", a: ["Constraint satisfaction","Sorting","Searching","Stack operations"], correct: 0 },
      { q: "Fibonacci DP approach?", a: ["Memoization","Recursion only","Iteration only","Backtracking"], correct: 0 },
      { q: "Topological sort used in?", a: ["DAG","Graph with cycles","Tree only","Heap"], correct: 0 },
      { q: "Shortest path negative edges?", a: ["Bellman-Ford","Dijkstra","Prim","Kruskal"], correct: 0 },
      { q: "Big-O represents?", a: ["Time complexity","Space complexity","Data type","Variable type"], correct: 0 },
      { q: "Binary search tree property?", a: ["Left<Root<Right","Left>Root>Right","Random order","All equal"], correct: 0 },
      { q: "Graph representation by adjacency matrix?", a: ["2D array","Linked list","Hash table","Queue"], correct: 0 },
      { q: "Graph representation by adjacency list?", a: ["Array of lists","2D array","Queue","Stack"], correct: 0 },
      { q: "Floyd-Warshall algorithm finds?", a: ["All pairs shortest path","Minimum spanning tree","DFS","BFS"], correct: 0 },
